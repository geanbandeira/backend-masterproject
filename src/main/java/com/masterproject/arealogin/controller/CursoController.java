...
import com.masterproject.arealogin.repository.CursoRepository; // Import corrigido para apontar para o pacote repository
...
public class CursoController {
    ...
    public List<Aula> listarAulasDoCurso(@PathVariable String cursoSlug) {
        // Supondo que você adicionará findByCursoSlug ao AulaRepository
