    ...
    public CommandLineRunner initData(
        ...
        return args -> {
            ...
            if (cursoRepository.count() == 0) {
                ...
                pmi2.setDescricao("Aprofunde-se nas técnicas de planejamento de escopo, tempo e custos.");

                Curso pmi3 = new Curso();
                pmi3.setTitulo("Gerenciamento de Projetos com Ênfase no PMI - Execução, Monitoramento e Controle");
                pmi3.setDescricao("Domine a execução e o controle de projetos para garantir a entrega de resultados.");

                Curso bpm = new Curso();
                bpm.setTitulo("Análise de Negócio - BPM");
                bpm.setDescricao("Entenda e modele processos de negócio para otimizar a performance da sua empresa.");
                ...
                jira.setDescricao("Gerencie seus projetos ágeis de forma eficiente com a ferramenta líder de mercado.");
                ...
                cursoRepository.saveAll(List.of(pbi, excel, gestao, trilha, pmi1, pmi2, pmi3, bpm, bizagi, jira, okr));
            ...
            if (aulaRepository.count() == 0 && cursoRepository.count() > 0) {
                ...
                gestaoAula1.setTitulo("Aula 1: O que é Gestão Híbrida?");
                ...
                pbiAula3.setConteudo("Criando relacionamentos entre tabelas e modelos de dados eficientes.");
                ...
                pbiAula4.setConteudo("Introdução à linguagem DAX para criação de medidas e colunas calculadas.");
                ...
                pbiAula5.setConteudo("Criando visualizações interativas e personalizadas para seus dashboards.");
                ...
                pbiAula6.setConteudo("Como publicar relatórios no Power BI Service e compartilhar com stakeholders.");
                pbiAula6.setVideoUrl("https://www.youtube.com/embed/SEU_OUTRO_VIDEO_AQUI");
                pbiAula6.setCurso(cursoPbi);

                todasAsAulas.addAll(List.of(pbiAula1, pbiAula2, pbiAula3, pbiAula4, pbiAula5, pbiAula6));
                ...
                excelAula1.setConteudo("Conhecendo a interface do Excel e conceitos básicos de planilhas.");
                ...
                excelAula2.setConteudo("Domine as principais funções do Excel: SOMA, SE, PROCV, CONT.SE, etc.");
                ...
                excelAula3.setConteudo("Trabalhando com tabelas dinâmicas e formatação condicional avançada.");
                ...
                excelAula6.setConteudo("Gravação e edição de macros para automatizar tarefas repetitivas.");
                excelAula6.setVideoUrl("https://www.youtube.com/embed/EXCEL_VIDEO_AQUI");
                excelAula6.setCurso(cursoExcel);

                todasAsAulas.addAll(List.of(excelAula1, excelAula2, excelAula3, excelAula4, excelAula5, excelAula6));
                ...
                pmi1Aula2.setConteudo("Processos de iniciação: termo de abertura e registro de partes interessadas.");
                ...
                pmi1Aula6.setConteudo("Consolidando todos os planos auxiliares no plano de gerenciamento do projeto.");
                pmi1Aula6.setVideoUrl("https://www.youtube.com/embed/PMI_VIDEO_AQUI");
                pmi1Aula6.setCurso(cursoPmi1);

                todasAsAulas.addAll(List.of(pmi1Aula1, pmi1Aula2, pmi1Aula3, pmi1Aula4, pmi1Aula5, pmi1Aula6));

                // --- AULAS PARA O CURSO PMI 2 - PLANEJAMENTO AVANÇADO ---
                Curso cursoPmi2 = cursoRepository
                        .findByTitulo("Gerenciamento de Projetos com Ênfase no PMI - Planejamento Avançado").get();
                ...
                pmi2Aula4.setConteudo("Planejamento de recursos humanos, físicos e materiais do projeto.");
                ...
                pmi2Aula5.setConteudo("Estratégia de comunicação, matriz de comunicação e canal de comunicação.");
                ...
                todasAsAulas.addAll(List.of(pmi2Aula1, pmi2Aula2, pmi2Aula3, pmi2Aula4, pmi2Aula5, pmi2Aula6));
                ...
                pmi3Aula1.setConteudo("Processos de execução: direcionar e gerenciar o trabalho do projeto.");
                ...
                pmi3Aula2.setConteudo("Gerenciar o conhecimento do projeto e realizar a garantia da qualidade.");
                ...
                pmi3Aula5.setConteudo("Validar e controlar o escopo, controlar o cronograma e os custos.");
                ...
                pmi3Aula6.setConteudo("Finalizar todas as atividades para encerrar formalmente o projeto ou fase.");
                pmi3Aula6.setVideoUrl("https://www.youtube.com/embed/PMI3_VIDEO_AQUI");
                pmi3Aula6.setCurso(cursoPmi3);

                todasAsAulas.addAll(List.of(pmi3Aula1, pmi3Aula2, pmi3Aula3, pmi3Aula4, pmi3Aula5, pmi3Aula6));
                ...
                bpmAula2.setConteudo("Técnicas para identificação e delimitação de processos de negócio.");
                ...
                bpmAula5.setConteudo("Implementação de processos melhorados e monitoramento de performance.");
                ...
                todasAsAulas.addAll(List.of(bpmAula1, bpmAula2, bpmAula3, bpmAula4, bpmAula5, bpmAula6));
                ...
                todasAsAulas
                        .addAll(List.of(bizagiAula1, bizagiAula2, bizagiAula3, bizagiAula4, bizagiAula5, bizagiAula6));

                // --- AULAS PARA O CURSO DE JIRA SOFTWARE ---
                Curso cursoJira = cursoRepository.findByTitulo("Jira Software - Gestão Ágil de Projetos e Operações")
                        .get();
                ...
                jiraAula2.setConteudo("Criação e configuração de projetos no Jira (Scrum, Kanban, etc).");
                ...
                jiraAula3.setConteudo("Criação, edição e transição de issues (tarefas, bugs, histórias).");
                ...
                jiraAula4.setConteudo("Configuração e utilização de boards Scrum e Kanban, planejamento de sprints.");
                ...
                jiraAula5.setConteudo("Utilização dos relatórios do Jira (velocity, burn-down, cumulative flow).");
                ...
                todasAsAulas.addAll(List.of(jiraAula1, jiraAula2, jiraAula3, jiraAula4, jiraAula5, jiraAula6));
                ...
                okrAula4.setConteudo("Como integrar OKRs no ciclo de vida de gerenciamento de projetos.");
                ...
                okrAula6.setConteudo("Como os OKRs transformam a cultura e a transparência nas organizações.");
                okrAula6.setVideoUrl("https://www.youtube.com/embed/OKR_VIDEO_AQUI");
                okrAula6.setCurso(cursoOkr);

                todasAsAulas.addAll(List.of(okrAula1, okrAula2, okrAula3, okrAula4, okrAula5, okrAula6));
                ...
                trilhaAula3.setConteudo("Criação de dashboard executivo integrando múltiplas fontes de dados.");
                ...
                trilhaAula4.setConteudo("Introdução à análise preditiva e machine learning no Power BI.");
                ...
                trilhaAula5.setConteudo("Automatizando fluxos de trabalho entre Excel, Power BI e outras ferramentas.");
                ...
                todasAsAulas
                        .addAll(List.of(trilhaAula1, trilhaAula2, trilhaAula3, trilhaAula4, trilhaAula5, trilhaAula6));
